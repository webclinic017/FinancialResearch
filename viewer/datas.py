...
def stockfeedapi(code: str, start: str, end: str, fromdate: str = None, todate: str = None):
    data = pq.Api.market_daily(start, end, fields=['t_tradingDate', 'c_windCode', 
        'n_adjOpen', 'n_adjHigh', 'n_adjLow', 'n_adjClose', 'n_volume'],
        conditions='c_windCode=%s' % code).droplevel(1)
