...
# --- Get Data
# pe data
pe = pq.Stock.derivative_indicator(start='20161230', end='20161230', fields='s_val_pe_ttm')
# price data
price = pq.Stock.market_daily(start='20170101', end='20170331', fields=['close', 'open'])
# stock pool in HS300
stock = pq.Stock.index_weight(start='20161230', end='20170331', fields='code', and_='index_code="000300.SH"')
